var styles = [ {
  ...
  "style" : [ {
    ...
    "selector" : "node[name = '01x11.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x05.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x04.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x06.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x09.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x08.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x07.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x02.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x03.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x01.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x10.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = '01x12.xml']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[BetweennessCentrality > 0.22146966]",
    "css" : {
    ...
    "selector" : "node[BetweennessCentrality > 0][BetweennessCentrality < 0.22146966]",
    "css" : {
      "background-color" : "mapData(BetweennessCentrality,0,0.22146966,rgb(252,141,89),rgb(179,0,0))"
    }
  }, {
    ...
    "selector" : "node[Degree > 1][Degree < 41]",
    "css" : {
      "font-size" : "mapData(Degree,1,41,21,30)"
    }
  }, {
    ...
    "selector" : "edge[countSpeechesInEpisode > 200]",
    "css" : {
      "width" : 1.0
    }
  }, {
    ...
    "selector" : "edge[countSpeechesInEpisode > 1][countSpeechesInEpisode < 200]",
    "css" : {
      "width" : "mapData(countSpeechesInEpisode,1,200,4.146341463414634,30.0)"
    }
  }, {
    "selector" : "edge[countSpeechesInEpisode = 1]",
    "css" : {
      "width" : 4.146341463414634
    }
  }, {
    "selector" : "edge[countSpeechesInEpisode < 1]",
    "css" : {
